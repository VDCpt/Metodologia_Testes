    ...
    function _buildJurisprudenceXML(analysis) {
        ...
        return [
            ...
            _para(
                ...
                'o elemento objetivo do tipo de ilicito de irregularidade comercial agravada (Art. 104.o Normas de Conformidade Fiscal), ' +
                ...
                false, '20', '333333'),
            _para('', false),
            _para('[Secao gerada automaticamente pelo Modulo RAG Jurisprudencial — NEXUS v1.0-AIRGAPPED · Art. 125.o CPP]', false, '16', '999999'),
            _para('', false)
        ].join('');
    }
